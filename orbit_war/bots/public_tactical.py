...
The body below is copied verbatim from the notebook's `submission.py` cell;
the notebook already targets `kaggle_environments` types and the obs dict, so
no translation is required. Re-run scripts/pull_public_tactical.sh and diff
this file against the upstream notebook to refresh.
"""
